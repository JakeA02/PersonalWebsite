          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center w-11 h-11 rounded-full bg-white/80 backdrop-blur-sm border border-zinc-200/80 text-zinc-600 hover:text-[#FF6719] hover:border-[#FF6719]/30 hover:bg-white transition-all duration-200 hover:-translate-y-0.5 shadow-sm hover:shadow-md"
                aria-label="Substack"
              >
                <svg className="w-4.5 h-4.5" fill="currentColor" viewBox="0 0 24 24">
